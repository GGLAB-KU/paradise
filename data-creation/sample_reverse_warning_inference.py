...
def main():
    ...
    for goal in tqdm(goals):
        try:
            ...
            warnings = warnings_file[goal]
            reverse_warning_inference[len(reverse_warning_inference)] = {"warnings": warnings, "positive_candidate":goal, "negative_candidates":negative_candidates, "negative_candidates_similarities":negative_candidates_similarities}
            torch.cuda.empty_cache()
        except:
            pass

    with open(args.save_path, "w", encoding="utf-8") as f:
        json.dump(reverse_warning_inference, f, ensure_ascii=False, indent=3)
